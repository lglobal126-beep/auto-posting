...
def analyze_food_photo_from_bytes(
    ...
    prompt = (
        "이 사진을 한국어로 상세하게 묘사해주세요.\n"
        "먼저 사진 종류를 파악한 뒤, 아래 기준에 맞게 묘사하세요.\n\n"
        "- 음식 사진: 음식 이름, 색감, 식감, 양, 비주얼 특징, 맛 추정을 2~3문장으로 작성\n"
        "- 메뉴판 사진: '[메뉴판]' 태그를 맨 앞에 붙이고 주요 메뉴명과 가격을 나열\n"
        "- 가게 외관 사진: '[외관]' 태그를 맨 앞에 붙이고 간판, 외부 분위기, 입지를 2~3문장으로 작성\n"
        "- 가게 내부/인테리어 사진: '[인테리어]' 태그를 맨 앞에 붙이고 실내 분위기, 좌석, 조명, 인테리어 특징을 2~3문장으로 작성\n\n"
        "영수증 사진인 경우에만 '해당없음'을 출력하세요."
    )
